export const ACCENT_CHARS = ["é", "è", "ê", "ë", "à", "â", "î", "ï", "ô", "û", "ù", "ç"];

export const ORAL_PROMPTS: Record<number, string> = {
...
export const WRITING_PROMPTS: Record<number, string> = {
...
export const EXAM_WRITING_PROMPTS: Record<number, string> = {
...
export const EXAM_ORAL_PROMPTS: Record<number, string> = {
